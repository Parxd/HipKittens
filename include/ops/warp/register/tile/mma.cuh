 ...
 * @param[in] scale_a The pointer to the scale factor for the A matrix. The actual scale value should be the least significant 8 bits of the 32 bit scale factor.
 * @param[in] scale_b The pointer to the scale factor for the B matrix. The actual scale value should be the least significant 8 bits of the 32 bit scale factor.
 */
template<ducks::rt::col_layout D, ducks::rt::row_layout A, ducks::rt::row_layout B, ducks::rt::col_layout C>
