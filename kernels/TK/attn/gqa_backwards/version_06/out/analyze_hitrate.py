...
aiter_hitrate = pivot[pivot['Kernel_Name'].str.contains('fmha_bwd_hd128')]
tk_hitrate = pivot[pivot['Kernel_Name'].str.contains('attend_bwd_combined_ker')]

# Print summary
pd.set_option('display.max_colwidth', 100)
print(aiter_hitrate[["Dispatch_Id", "Kernel_Name", "TCP_TOTAL_CACHE_ACCESSES_sum"]])
print(tk_hitrate[["Dispatch_Id", "Kernel_Name", "TCP_TOTAL_CACHE_ACCESSES_sum"]])