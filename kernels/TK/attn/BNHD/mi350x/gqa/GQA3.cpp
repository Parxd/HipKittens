...
__global__ void attend_ker(const attn_globals<D> g) {
    ...
    const int num_tiles = ATTN_N / BLOCK_SIZE;
    ...
    prefill_swizzled_offsets<1, false, st_bf<BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<BLOCK_SIZE, ATTN_D>>, NUM_THREADS>(g.Kg, {batch_idx, 0, head_idx_kv, 0}, k_smem[0], swizzled_offsets_K);
    prefill_swizzled_offsets<1, false, st_bf<BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<BLOCK_SIZE, ATTN_D>>, NUM_THREADS>(g.Vg, {batch_idx, 0, head_idx_kv, 0}, v_smem[0], swizzled_offsets_V);

    load_global_to_shared_direct_with_swizzled_offsets<1, false, st_bf<BLOCK_SIZE, ATTN_D>, _gl_QKVO, coord<st_bf<BLOCK_SIZE,ATTN_D>>, NUM_THREADS>(
